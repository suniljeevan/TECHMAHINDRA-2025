...
<div class="container mt-5">
    ...
    <form action="update-studentPost" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="email" name="email" value="<%= student.getEmail() %>" required>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="year" name="year" value="<%= student.getYear() %>" required>
        </div>
